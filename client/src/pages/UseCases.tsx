...
import { Bot, ShoppingCart, Plane, Heart, Building2, Wifi, Shield, ArrowRight, Check, TrendingUp, Clock, Star } from "lucide-react";
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#050508]/95 backdrop-blur-md border-b border-white/8">
      <div className="container mx-auto flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="/use-cases" className="nav-link" style={{ color: "white" }}>Use Cases</a>
                ...
                <div className="p-8 grid lg:grid-cols-2 gap-10">
                  ...
                  <div>
                    ...
                    <div className="flex gap-6 mb-6">
                      {ind.stats.map((s) => (
                        <div key={s.label}>
                          <p className="text-2xl font-bold text-white" style={{ fontFamily: "Space Grotesk, sans-serif", color: ind.color }}>{s.value}</p>

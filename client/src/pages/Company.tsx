...
import { Users, Globe, Zap, Heart, Linkedin } from "lucide-react";
...
const milestones = [
  ...
  { year: "2025", event: "Series B: $80M. Expanding to APAC & LATAM." },
  { year: "2026", event: "500+ enterprise customers across 40 countries." },
];
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              ...
              { value: "$80M", label: "Series B raised" },
            ].map(({ value, label }) => (
              <div key={label}>
